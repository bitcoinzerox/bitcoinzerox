...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hexxcoin: URIs)"));
...
#ifdef Q_OS_MAC
    xnodeAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_5));
#else
    xnodeAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
#endif
    ...
    openAction->setStatusTip(tr("Open a hexxcoin: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible hexxcoin command-line options").arg(tr(PACKAGE_NAME)));
