    ...
    if (fHelp ||
        ...
        throw std::runtime_error(
                "znode \"command\"...\n"
                        ...
                        "  start-alias  - Start single remote znode by assigned alias configured in hexxnode.conf\n"
                        "  start-<mode> - Start remote znodes configured in hexxnode.conf (<mode>: 'all', 'missing', 'disabled')\n"
                        "  status       - Print znode status information\n"
                        "  list         - Print list of all known znodes (see znodelist for more info)\n"
                        "  list-conf    - Print hexxnode.conf in JSON format\n"
    ...
    if (fHelp ||
        ...
        throw std::runtime_error(
                "znodebroadcast \"command\"...\n"
                        ...
                        "1. \"command\"        (string or set of strings, required) The command to execute\n"
                        "\nAvailable commands:\n"
                        "  create-alias  - Create single remote znode broadcast message by assigned alias configured in hexxnode.conf\n"
                        "  create-all    - Create remote znode broadcast messages for all znodes configured in hexxnode.conf\n"
