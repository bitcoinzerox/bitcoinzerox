...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_8_XNODE_PAYMENT_ENFORCEMENT:    r = SPORK_8_XNODE_PAYMENT_ENFORCEMENT_DEFAULT; break;
            case SPORK_9_SUPERBLOCKS_ENABLED:               r = SPORK_9_SUPERBLOCKS_ENABLED_DEFAULT; break;
            case SPORK_10_XNODE_PAY_UPDATED_NODES:     r = SPORK_10_XNODE_PAY_UPDATED_NODES_DEFAULT; break;
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_8_XNODE_PAYMENT_ENFORCEMENT:    return SPORK_8_XNODE_PAYMENT_ENFORCEMENT_DEFAULT;
        case SPORK_9_SUPERBLOCKS_ENABLED:               return SPORK_9_SUPERBLOCKS_ENABLED_DEFAULT;
        case SPORK_10_XNODE_PAY_UPDATED_NODES:     return SPORK_10_XNODE_PAY_UPDATED_NODES_DEFAULT;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_8_XNODE_PAYMENT_ENFORCEMENT:    return "SPORK_8_XNODE_PAYMENT_ENFORCEMENT";
        case SPORK_9_SUPERBLOCKS_ENABLED:               return "SPORK_9_SUPERBLOCKS_ENABLED";
        case SPORK_10_XNODE_PAY_UPDATED_NODES:     return "SPORK_10_XNODE_PAY_UPDATED_NODES";
