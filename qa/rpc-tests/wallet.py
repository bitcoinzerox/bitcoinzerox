...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 HXX from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 hxx in block rewards plus fees, but
        ...
        # Send 10 HXX with subtract fee from amount
        ...
        # Sendmany 10 HXX with subtract fee from amount
